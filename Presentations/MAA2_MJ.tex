	...
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\onslide<3>{
				...
				\node[fish, rotate=10] (coh1) at ($(focal2) + (-0.05, 0.4)$) {};
				\node[fish, rotate=-15] (coh2) at ($(focal2) + (-0.45, 0.2)$) {};
				\node[fish, rotate=25] (coh3) at ($(focal2) + (-0.4, -0.25)$) {};
				\node[fish, rotate=-5] (coh4) at ($(focal2) + (-0.1, -0.4)$) {};
			...
			\onslide<4>{
				...
				\node[fish, rotate=15] (fish1) at ($(focal) + (-0.25, 0.1)$)  {};
				\node[fish, rotate=-15] (fish2) at ($(focal) + (0.3, 0.3)$) {};
				\node[fish, rotate=-35] (fish3) at ($(focal) + (-0.3, -0.6)$) {};
